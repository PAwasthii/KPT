  ...
  async getMyStats(req: Request, res: Response) {
    try {
      ...
      const [
        ...
        prisma.lead.count({
          where: { ownerId: userId, status: LeadStatus.QUALIFIED, deletedAt: null },
        }),
        prisma.lead.count({
          where: { ownerId: userId, status: LeadStatus.UNQUALIFIED, deletedAt: null },
        }),
        prisma.lead.count({
          where: { ownerId: userId, status: LeadStatus.WORKING, deletedAt: null },
        }),
        prisma.lead.count({
