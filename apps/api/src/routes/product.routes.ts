...
router.get('/search', requireRole([UserRole.SYSTEM_ADMIN, UserRole.ADMIN]), productController.searchProducts.bind(productController));

// Get all products with filters (admin only)
router.get('/', requireRole([UserRole.SYSTEM_ADMIN, UserRole.ADMIN]), productController.getAllProducts.bind(productController));

// Get product by ID
router.get('/:id', requireRole([UserRole.SYSTEM_ADMIN, UserRole.ADMIN]), productController.getProductById.bind(productController));
