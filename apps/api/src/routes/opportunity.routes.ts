...
router.get('/:opportunityId', opportunityController.getOpportunityById.bind(opportunityController));

// PATCH /api/opportunity/:opportunityId - Update an opportunity
router.patch('/:opportunityId', opportunityController.updateOpportunity.bind(opportunityController));

// DELETE /api/opportunities/:opportunityId - Delete an opportunity (soft delete)
router.delete('/:opportunityId', opportunityController.deleteOpportunity.bind(opportunityController));

// POST /api/opportunities/:id/generate-quote - Generate quote from opportunity
router.post('/:id/generate-quote', opportunityController.generateQuote.bind(opportunityController));

// POST /api/opportunities/:id/submit - Submit opportunity for approval (checks discount threshold)
router.post('/:id/submit', opportunityController.submitOpportunityForApproval.bind(opportunityController));
 ...
 *  }
 */
router.get('/:opportunityId/quotes', opportunityController.getOpportunityQuotes.bind(opportunityController));

// GET /api/opportunities/:opportunityId/line-items - Get all line items for an opportunity
router.get('/:opportunityId/line-items', opportunityController.getOpportunityLineItems.bind(opportunityController));

// POST /api/opportunities/:opportunityId/line-items - Add a line item to an opportunity
router.post('/:opportunityId/line-items', opportunityController.addOpportunityLineItem.bind(opportunityController));

// PATCH /api/opportunities/:opportunityId/line-items/:lineItemId - Update a line item
router.patch('/:opportunityId/line-items/:lineItemId', opportunityController.updateOpportunityLineItem.bind(opportunityController));

// DELETE /api/opportunities/:opportunityId/line-items/:lineItemId - Delete a line item (hard delete)
router.delete('/:opportunityId/line-items/:lineItemId', opportunityController.deleteOpportunityLineItem.bind(opportunityController));
