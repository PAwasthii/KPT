...
router.get('/:id/get-order-details', salesOrderController.getOrderDetails.bind(salesOrderController));

// GET /api/sales-orders/:id/line-items - Get line items
router.get('/:id/line-items', salesOrderController.getLineItems.bind(salesOrderController));

// GET /api/sales-orders/:id/pdf - Generate sales order PDF
router.get('/:id/pdf', salesOrderController.generatePdf.bind(salesOrderController));
