...
router.post('/templates/upload-media', (req, res) => controller.uploadTemplateMedia(req, res));
router.put('/templates/:name', (req, res) => controller.updateTemplate(req, res));
router.delete('/templates/:name', (req, res) => controller.deleteTemplate(req, res));

// Campaigns
router.post('/campaigns/upload-media', (req, res) => controller.uploadCampaignMedia(req, res));
...
router.get('/campaigns/:id/config', (req, res) => controller.getCampaignConfig(req, res));
