...
export function setupRoutes(app: Express) {
  ...
  app.use('/api/pricebooks', requireAuth, pricebookRoutes);
  app.use('/api/pricebook-entries', requireAuth, pricebookEntryRoutes);
  ...
  // Tax registration verification — country-aware (any authenticated user)
  app.use('/api/tax', requireAuth, taxVerifyRoutes);
