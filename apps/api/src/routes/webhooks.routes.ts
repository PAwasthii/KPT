...
router.post('/msg91/whatsapp', (req, res) => whatsappController.handleWebhook(req, res));

// MSG91 WhatsApp inbound messages webhook (for STOP messages and opt-outs)
router.post('/msg91/whatsapp/inbound', (req, res) => whatsappController.handleInboundMessage(req, res));
