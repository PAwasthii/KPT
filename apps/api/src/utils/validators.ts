 ...
 */
export function isValidPhoneForImport(phone: string | null | undefined): boolean {
  if (!phone || typeof phone !== 'string') {
    return false;
  }
  const trimmed = phone.trim();
 ...
 */
export function isValidEmailForImport(email: string | null | undefined): boolean {
  if (!email || typeof email !== 'string') {
    return false;
  }
 ...
 */
export function isValidPincodeForImport(pincode: string | null | undefined): boolean {
 ...
 */
export function isValidCompanyForImport(company: string | null | undefined): boolean {
