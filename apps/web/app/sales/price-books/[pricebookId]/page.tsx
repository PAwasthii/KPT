  ...
  if (pbLoading) {
    return (
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="text-sm text-muted-foreground">Loading price book...</div>
      </div>
    );
  }
          ...
          <TabsContent value="details">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2 space-y-4">
                <DetailCard title="Price Book Information" className="bg-gray-50/50 border-gray-200">
                  <InfoGrid columns={2}>
                    <InfoField label="Name" value={pb.name} />
                    <InfoField label="Currency" value={pb.currencyISOCode ?? "—"} />
              ...
              <div className="space-y-4">
                <DetailCard title="System Information" className="bg-gray-50/50 border-gray-200">
                  <InfoGrid columns={1}>
                    <InfoField
                      label="Created At"
                      value={new Date(pb.createdAt).toLocaleDateString("en-GB", {
                        day: "2-digit",
                        month: "long",
                        year: "numeric",
                      })}
                    ...
                    <InfoField
                      label="Last Modified"
                      value={new Date(pb.updatedAt).toLocaleDateString("en-GB", {
                        day: "2-digit",
                        month: "long",
                        year: "numeric",
                      })}
