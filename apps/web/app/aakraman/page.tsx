        ...
        <Card className="w-full max-w-lg rounded-3xl border-0 shadow-2xl">
          <CardHeader className="space-y-4 text-center">
            <div className="relative mx-auto flex items-center justify-center overflow-hidden rounded-3xl">
              <Image src={logov3} height={200} width={200} alt="Aakraman logo" className="object-contain" priority />
            </div>
            <div>
            ...
            {step === "input" ? (
              <>
                <div className="space-y-2">
                  ...
                  {getFieldHelper("email") && (
                    <p className="text-xs font-medium text-red-600">{getFieldHelper("email")}</p>
                  )}
                </div>
              ...
              <div className="space-y-5">
                <div className="space-y-2">
                  ...
                  />
                  {getFieldHelper("otp") && (
                    <p className="text-xs font-medium text-red-600">{getFieldHelper("otp")}</p>
                  )}
                </div>
