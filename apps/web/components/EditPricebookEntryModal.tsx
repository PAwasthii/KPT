...
export const EditPricebookEntryModal: React.FC<Props> = ({ open, onOpenChange, entry }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const message = (err as any)?.message || 'Failed to update price book entry';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContentAny className="sm:max-w-[480px]">
        <DialogHeaderAny className="text-center">
          <DialogTitleAny className="text-center">Edit Price Book Entry</DialogTitleAny>
          <DialogDescriptionAny className="text-center">
            Update the details for this price book entry.
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            <Checkbox id="isActive" checked={form.isActive} onCheckedChange={updateChecked("isActive")} />
            <label
              htmlFor="isActive"
        ...
        <DialogFooterAny>
          ...
          <Button
            ...
            disabled={updatePricebookEntry.isPending || (submitAttempted && hasErrors)}
          >
