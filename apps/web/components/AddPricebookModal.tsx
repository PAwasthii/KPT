...
import { useCreatePricebook } from "../hooks/usePricebooks";
      ...
      <DialogContentAny className="sm:max-w-[480px]">
        <DialogHeaderAny className="text-center">
          ...
          <DialogDescriptionAny className="text-center">
            Create a new pricebook by providing a name and an optional description.
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              aria-invalid={shouldShowError("description") && !!errors.description}
              aria-describedby={shouldShowError("description") && errors.description ? "description-error" : undefined}
            />
        ...
        <DialogFooterAny>
          ...
          <Button
            ...
            disabled={createPricebook.isPending || (submitAttempted && hasErrors)}
          >
