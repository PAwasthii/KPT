...
export function ContactDetailPage({
  ...
  const { data: analyticsEvents = [], isLoading: analyticsLoading } = useAnalyticsByContact(contactId)
                  ...
                  <CardContent>
                    <div className="max-h-[400px] overflow-y-auto">
                      {analyticsLoading ? (
                        ...
                        <div className="text-muted-foreground text-sm">No recorded activity yet.</div>
                      )}
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Mailing Address</p>
                          <p className="text-sm font-medium text-gray-700">{editedContact.mailingAddress || "N/A"}</p>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-700">{editedContact.city || "N/A"}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-700">{editedContact.state || "N/A"}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-700">{editedContact.zipCode || "N/A"}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-700">{editedContact.country || "N/A"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-700 leading-relaxed">{editedContact.description || "N/A"}</p>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">LinkedIn</p>
                            <p className="text-sm font-medium text-gray-700">{editedContact.linkedin || "N/A"}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Preferred Contact</p>
                            <p className="text-sm font-medium text-gray-700">{editedContact.preferredContactMethod || "N/A"}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-sky-50">
                          ...
                          <div>
                            <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Alternate Email</p>
                            <p className="text-sm font-medium text-gray-700">{editedContact.alternateEmail || "N/A"}</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Time Zone</p>
                            <p className="text-sm font-medium text-gray-700">{editedContact.timeZone || "N/A"}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-700">{transformedContact.createdBy}</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-purple-50">
                        ...
                        <div>
                          <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Last Updated</p>
                          <p className="text-sm font-medium text-gray-700">{transformedContact.lastUpdatedBy}</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Contact Status</p>
                          <Badge
