      ...
      <div className="space-y-6">
        ...
        <DetailCard title="Address Information">
          <div className="space-y-4">
            {/* Billing */}
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-3">Billing Address</p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 flex-1">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Street</p>
                      <p className="text-sm font-medium text-gray-700">{safeEditedAccount.billingAddress.street}</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">City</p>
                      <p className="text-sm font-medium text-gray-700">{safeEditedAccount.billingAddress.city}</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">State</p>
                      <p className="text-sm font-medium text-gray-700">{safeEditedAccount.billingAddress.state}</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Zip Code</p>
                      <p className="text-sm font-medium text-gray-700">{safeEditedAccount.billingAddress.zipCode}</p>
                    </div>
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Country</p>
                      <p className="text-sm font-medium text-gray-700">{safeEditedAccount.billingAddress.country}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t border-gray-100 pt-4">
              <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-3">Shipping Address</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="grid grid-cols-2 gap-3 flex-1">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Street</p>
                    <p className="text-sm font-medium text-gray-700">{safeEditedAccount.shippingAddress.street}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">City</p>
                    <p className="text-sm font-medium text-gray-700">{safeEditedAccount.shippingAddress.city}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">State</p>
                    <p className="text-sm font-medium text-gray-700">{safeEditedAccount.shippingAddress.state}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Zip Code</p>
                    <p className="text-sm font-medium text-gray-700">{safeEditedAccount.shippingAddress.zipCode}</p>
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Country</p>
                    <p className="text-sm font-medium text-gray-700">{safeEditedAccount.shippingAddress.country}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <DetailCard title="Additional Information">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Description / Notes</p>
                <p className="text-sm font-medium text-gray-700 leading-relaxed">{safeEditedAccount.description}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Annual Revenue</p>
                <p className="text-sm font-medium text-gray-700">{safeEditedAccount.annualRevenue}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-blue-50">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Company Size</p>
                <p className="text-sm font-medium text-gray-700">{safeEditedAccount.companySize}</p>
              </div>
            </div>
          </div>
        </DetailCard>
        ...
        <DetailCard title="System Information">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-0.5">Account Owner</p>
                <p className="text-sm font-medium text-gray-700">{safeAccount.accountOwner}</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-blue-50">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-700">
                  {apiAccount?.createdAt
                    ? new Date(apiAccount.createdAt).toLocaleString('en-GB', { day: '2-digit', month: '2-digit', year: '2-digit', hour: '2-digit', minute: '2-digit', hour12: true })
