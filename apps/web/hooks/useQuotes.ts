...
import type { QuoteListItem, QuoteDetail, QuoteLineItemApi, QuoteOrderItem } from '../lib/api/types'
...
export const quoteKeys = {
  ...
  lineItems: (quoteId: string | undefined, params?: { page?: number; limit?: number }) =>
