 ...
 */
export function formatPhoneWithCountryCode(phone?: string | null, countryCode?: string | null): string {
 ...
 */
export function displayPhone(phone?: string | null, countryCode?: string | null): string {
  if (!phone) return 'N/A';
