...
export interface QuoteListItem {
  ...
  opportunity?: { id: number; opportunityNumber?: string; name: string; stage?: string };
...
export interface QuoteDetail {
  ...
  account?: { id: number; name: string };
  contact?: { id: number; name: string; email?: string } | null;
  preparedBy?: { id: number; firstName: string | null; lastName: string | null };
  approvedBy?: { id: number; firstName: string | null; lastName: string | null } | null;
  rejectedBy?: { id: number; firstName: string | null; lastName: string | null } | null;
...
export interface ApprovalProcessApi {
  ...
  createdAt: string
  updatedAt: string
  requestedTo?: { id: number; firstName: string | null; lastName: string | null; email: string }
  createdBy?: { id: number; firstName: string | null; lastName: string | null; email: string }
  lastActor?: { id: number; firstName: string | null; lastName: string | null } | null
}
